...
{
    public abstract class SchoolManagementWebTestBase : AbpAspNetCoreIntegratedTestBase<Startup>
    {
        protected static readonly Lazy<string> ContentRootFolder;

        static SchoolManagementWebTestBase()
        {
        ...
        protected override IWebHostBuilder CreateWebHostBuilder()
        {
            return base
                ...
                .UseSetting(WebHostDefaults.ApplicationKey, typeof(SchoolManagementWebMvcModule).Assembly.FullName);
        }
        ...
        {
            using (var context = IocManager.Resolve<SchoolManagementDbContext>())
            {
                action(context);
                context.SaveChanges();
            }
        ...
        protected async Task UsingDbContextAsync(Func<SchoolManagementDbContext, Task> action)
        {
            using (var context = IocManager.Resolve<SchoolManagementDbContext>())
            {
        ...
        protected async Task<T> UsingDbContextAsync<T>(Func<SchoolManagementDbContext, Task<T>> func)
        {
            T result;
