...
export class ClassServiceProxy {
     ...
     * @return OK
     */
    create(body: CreateClassDto | undefined): Observable<void> {
     ...
     * @return OK
     */
    get(input: number | undefined): Observable<ClassDto> {
     ...
     * @return OK
     */
    update(body: ClassDto | undefined): Observable<void> {
     ...
     * @return OK
     */
    getAll(keyword: string | undefined, isActive: boolean | undefined, skipCount: number | undefined, maxResultCount: number | undefined): Observable<ClassDtoPagedResultDto> {
...
export class ExamServiceProxy {
     ...
     * @return OK
     */
    create(body: CreateExamDto | undefined): Observable<void> {
        let url_ = this.baseUrl + "/api/services/app/Exam/Create";
        url_ = url_.replace(/[?&]$/, "");
    ...
    delete(input: number | undefined): Observable<void> {
        let url_ = this.baseUrl + "/api/services/app/Exam/Delete?";
        if (input === null)
            throw new Error("The parameter 'input' cannot be null.");
        else if (input !== undefined)
            url_ += "input=" + encodeURIComponent("" + input) + "&";
     ...
     * @return OK
     */
    getAll(keyword: string | undefined, skipCount: number | undefined, maxResultCount: number | undefined): Observable<ExamDtoPagedResultDto> {
        let url_ = this.baseUrl + "/api/services/app/Exam/GetAll?";
        if (keyword === null)
            throw new Error("The parameter 'keyword' cannot be null.");
        else if (keyword !== undefined)
            url_ += "Keyword=" + encodeURIComponent("" + keyword) + "&";
        ...
        return this.http.request("get", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            ...
            if (response_ instanceof HttpResponseBase) {
                try {
                    ...
                    return _observableThrow(e) as any as Observable<ExamDtoPagedResultDto>;
                }
            } else
                return _observableThrow(response_) as any as Observable<ExamDtoPagedResultDto>;
        }));
    }

    protected processGetAll(response: HttpResponseBase): Observable<ExamDtoPagedResultDto> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (response as any).error instanceof Blob ? (response as any).error : undefined;
        ...
        if (status === 200) {
            ...
            let result200: any = null;
            let resultData200 = _responseText === "" ? null : JSON.parse(_responseText, this.jsonParseReviver);
            result200 = ExamDtoPagedResultDto.fromJS(resultData200);
            return _observableOf(result200);
            }));
        } else if (status !== 200 && status !== 204) {
            return blobToText(responseBlob).pipe(_observableMergeMap((_responseText: string) => {
     ...
     * @return OK
     */
    get(input: number | undefined): Observable<ExamDto> {
        let url_ = this.baseUrl + "/api/services/app/Exam/Get?";
        if (input === null)
            throw new Error("The parameter 'input' cannot be null.");
        else if (input !== undefined)
            url_ += "input=" + encodeURIComponent("" + input) + "&";
     ...
     * @return OK
     */
    update(body: CreateExamDto | undefined): Observable<void> {
        let url_ = this.baseUrl + "/api/services/app/Exam/Update";
        url_ = url_.replace(/[?&]$/, "");
...
export class TeacherServiceProxy {
     ...
     * @return OK
     */
    get(input: number | undefined): Observable<TeacherDto> {
     ...
     * @return OK
     */
    getAll(keyword: string | undefined, isActive: boolean | undefined, skipCount: number | undefined, maxResultCount: number | undefined): Observable<TeacherDtoPagedResultDto> {
...
export class UserServiceProxy {
     ...
     */
    getRoleForEdit(id: number | undefined): Observable<GetRoleForEditOutput> {
        let url_ = this.baseUrl + "/api/services/app/User/GetRoleForEdit?";
        if (id === null)
            throw new Error("The parameter 'id' cannot be null.");
        else if (id !== undefined)
            url_ += "Id=" + encodeURIComponent("" + id) + "&";
...
export class CreateExamDto implements ICreateExamDto {
    ...
    static fromJS(data: any): CreateExamDto {
        data = typeof data === 'object' ? data : {};
        let result = new CreateExamDto();
        result.init(data);
        return result;
    }
...
export class ExamDtoPagedResultDto implements IExamDtoPagedResultDto {
    items: ExamDto[] | undefined;
    totalCount: number;

    constructor(data?: IExamDtoPagedResultDto) {
        if (data) {
            for (var property in data) {
                if (data.hasOwnProperty(property))
                    (<any>this)[property] = (<any>data)[property];
    ...
    static fromJS(data: any): ExamDtoPagedResultDto {
        data = typeof data === 'object' ? data : {};
        let result = new ExamDtoPagedResultDto();
        result.init(data);
        return result;
    }
...
export interface IExamDtoPagedResultDto {
    items: ExamDto[] | undefined;
    totalCount: number;
}
