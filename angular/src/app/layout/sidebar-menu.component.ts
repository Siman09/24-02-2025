...
export class SidebarMenuComponent extends AppComponentBase implements OnInit {
    ...
    getMenuItems(): MenuItem[] {
        return [
            ...
            new MenuItem(this.l('Students'), '/app/students', 'fas fa-home','pages.StudentManagement'),
            new MenuItem(this.l('Class'), '/app/classes', 'fas fa-home','pages.ClassManagement'),
            new MenuItem(this.l('Teacher'), '/app/teachers', 'fas fa-home','pages.TeacherManagement'),
            new MenuItem(this.l('Exam'), '/app/exam', 'fas fa-home','pages.ExamManagement'),
            new MenuItem(
                this.l('Roles'),
                '/app/roles',
